    ...
    public class RoleService : IRoleService
    {
        ...
        public int CreateRole(Role role)
        {
            ...
            foreach (Permission permission in role.Permissions)
            {
                ...
                secRolePermission.PermissionId = (uint)permission.PermissionId;
        ...
        public int UpdateRole(Role uiRole)
        {
            ...
            HashSet<uint> oldPermissionIdSet = new HashSet<uint>(oldRole.SecRolePermission.Select(p => p.PermissionId));
            ...
            foreach (int newPermissionId in newPermissionIdSet)
            {
                ...
                uint permissionId = (uint)newPermissionId;
                if (oldPermissionIdSet.Contains(permissionId) == false)
                {
            ...
            {
                uint addToPermId = (uint)addToPermissionId;
                SecRolePermission newSecRolePerm = new SecRolePermission
                {
                    RoleId = updatedRole.RoleId,
                    PermissionId = addToPermId
                };
