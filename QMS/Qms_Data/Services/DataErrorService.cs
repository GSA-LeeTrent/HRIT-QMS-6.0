...
namespace QmsCore.Services
{
    public class DataErrorService : BaseService<DataError>, IDataErrorService
    {
        ...
        internal int archiveDayCount = -3; //changed from the original value of -30 
...
#region "Update methods"
        ...
        public int? Save(int errorId, string details, int actionId, User submitter, int? assigneeId)
        {
            ...
            {
                d.AssignedByUserId = (uint)submitter.ID;
                d.AssignedToUserId = (uint)assigneeId;
        ...
        // Save returns the value of the associated Corrective Action which is an nullable ihnt (int?) type. 
        // The 
        //
