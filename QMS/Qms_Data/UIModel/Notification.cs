...
namespace QmsCore.UIModel
{
    ...
    {
        private sbyte trueByte = 1;
        private sbyte falseByte = 0;
        ...
        public Notification(QmsCore.Model.NtfNotification notification)
        {
            ...
            this.UserId = (int)notification.UserId;
            this.WorkitemId = (int)notification.WorkitemId;
        ...
        public NtfNotification NtfNotification()
        {
            ...
            notification.UserId = (uint)this.UserId;
            notification.WorkitemId = (uint)this.WorkitemId;
