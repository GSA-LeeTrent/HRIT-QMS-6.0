...
namespace QmsCore.UIModel
{
    public class CorrectiveAction : IListable, IMessageCreatable
    {
        ...
        public string Message {get {return  string.Format(Template,Id,EmplId, Employee.FullName, getActionRequestType((int)ActionRequestTypeId.Value) ,NOACode,EffectiveDateOfPar,getDateToUse(),Details);}}
        ...
        internal QmsCorrectiveactionrequest QmsCorrectiveActionRequest
        {
            get{
                ...
                r.ActionRequestTypeId = (int)this.ActionRequestTypeId;
                ...
                r.Id = this.Id;
                r.CreatedAtOrgId = (uint)this.CreatedAtOrgId;
                ...
                r.RowVersion = (sbyte)this.RowVersion;
                return r;
            }
        }
