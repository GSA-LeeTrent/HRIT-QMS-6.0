...
namespace QmsCore.UIModel
{
    public class WorkItemFile
    {
        ...
        {
            this.Id = file.Id;
            this.UploadedByUserId = (int?)file.UploadedByUserId;
            this.WorkItemId = (int)file.WorkItemId;
        ...
        public QmsWorkitemfile QmsWorkitemfile()
        {
            ...
            wif.UploadedByUserId = (uint)this.UploadedByUserId;
            wif.WorkItemId = (uint)this.WorkItemId;
