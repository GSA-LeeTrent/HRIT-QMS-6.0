    ...
    public class User : ILoggable
    {
        ...
        public User(SecUser user)
        {
            try
            {
                ...
                this.OrgId = (int?)user.OrgId;
                this.ManagerId = (int?)user.ManagerId;
        ...
        internal SecUser SecUser()
        {
            ...
            secUser.ManagerId = (uint?)this.ManagerId;
            secUser.OrgId = (uint)this.OrgId;
            secUser.UpdatedAt = this.UpdatedAt;
            secUser.UserId = (uint)this.UserId;

            foreach(var userrole in UserRoles)
            {
                SecUserRole secUserRole = new SecUserRole();
                secUserRole.RoleId = userrole.RoleId;
                secUserRole.UserId = (uint)this.UserId;
