...
namespace QmsCore.Engine
{
    internal class BaseNotificationEngine
    {
        ...
        internal List<SecUser> getReviewersInOrgByRoleName(int OrgId, string roleName)
        {
            return userRepository.RetrieveAllReviewersByOrganizationIdAndReviewerType(OrgId, roleName);
        }
