...
namespace QmsCore.Engine
{
    internal class CorrectiveActionRoutingEngine : BaseRoutingEngine
    {
        ...
        internal int ExecuteUpdates(CorrectiveAction correctiveAction, User submittedBy, string history)
        {
            ...
            this.entity.StatusId = (uint)action.ToStatus.StatusId;
            if(isNewTicket)
            {
                this.entity.CreatedAt = DateTime.Now;
                this.entity.CreatedByUserId = (uint)submitter.UserId;
                this.entity.CreatedAtOrgId= (uint)submitter.OrgId.Value;
                this.entity.AssignedToOrgId = (uint)submitter.OrgId.Value;
        ...
        private void SubmitForResolution()
        {
            ...
            int currentOrgId = entity.AssignedToOrgId.HasValue ? (int)entity.AssignedToOrgId.Value : submitter.OrgId.Value;
            ...
            entity.StatusId = (uint)referenceRepository.GetStatus(StatusType.UNASSIGNED).StatusId;
